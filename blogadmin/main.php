              ...
              <div class="panel-heading">
                <div class="row">
                  ...
                  <div class="col-xs-6 text-right">
                    ...
                    <p class="announcement-text"><strong>Postingan</strong></p>
                  </div>
                </div>
              </div>
              ...
              <div class="panel-heading">
                <div class="row">
                  ...
                  <div class="col-xs-6 text-right">
                    ...
                    <p class="announcement-text"><strong>Terpublish</strong></p>
                  </div>
                </div>
              </div>
              <a href="blogs_view.php">
              ...
              <div class="panel-heading">
                <div class="row">
                  ...
                  <div class="col-xs-6 text-right">
                    ...
                    <p class="announcement-text"><strong>Draft</strong></p>
                  </div>
                </div>
              </div>
              <a href="#">
