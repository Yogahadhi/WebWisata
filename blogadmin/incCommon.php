	...
	*/
	...
	function getTableList($skip_authentication = false){
		...
		$arrTables = array(
			...
			'titles' => array('Detail Website', '', 'resources/table_icons/drugs_com.png', 'None'),
			'links' => array('Link', '', 'resources/table_icons/firefox.png', 'None'),
			'blog_categories' => array('Kategori', '', 'resources/table_icons/award_star_bronze_2.png', 'None'),
			'blogs' => array('Postingan', '', 'resources/table_icons/feed.png', 'None'),
			'editors_choice' => array('Populer', '', 'resources/table_icons/bullet_star.png', 'None')
		);
	...
	function htmlUserBar(){
		...
		?>
		<nav class="navbar navbar-default navbar-fixed-top hidden-print" style="background-color:#016345" role="navigation">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="<?php echo PREPEND_PATH; ?>index.php"><i class="glyphicon glyphicon-home"></i> Desa Salenrang Admin</a>
			</div>
