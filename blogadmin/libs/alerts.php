...
if ($currentuser=="admin") {
  ...
  <strong><span class="fa fa-bullhorn fa-2x"></span> </strong> <strong>&nbsp;&nbsp;Selamat Datang di dashboard admin!!</strong>.
  </div>';
}
elseif ($currentuser=="guest") {
  ...
  redirect("index.php?signIn=1");
    ...
    <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
    <strong><span class="fa fa-bullhorn fa-2x"></span> </strong> <strong>&nbsp;&nbsp;Selamat Datang di dashboard Blog!!</strong>.
    </div>';
  }
?>
